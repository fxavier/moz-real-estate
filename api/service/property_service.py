...
class PropertyService:
    ...
    def get_properties_with_cover_images(self):
        ...
        return [
            schemas.PropertyWithCoverImage(
                ...
                badrooms=property.badrooms,
                bathrooms=property.bathrooms,
                dinnigrooms=property.dinnigrooms,
                kitchens=property.kitchens,
                sittingrooms=property.sittingrooms,
                wifi=property.wifi,
    ...
    def get_property_with_subscription(self):
        ...
        response_model = schemas.PropertyWithSubscription(properties=result)
