...
class Property(Base):
   ...
   # images = Column(ARRAY(String), nullable=True)  # PostgreSQL ARRAY
    badrooms = Column(Integer, nullable=True)
    bathrooms = Column(Integer, nullable=True)
    dinnigrooms = Column(Integer, nullable=True)
    kitchens = Column(Integer, nullable=True)
    sittingrooms = Column(Integer, nullable=True)
    wifi = Column(Integer, nullable=True) 
    parking = Column(Integer, nullable=True)
    swimming_pool = Column(Integer, nullable=True)
